...
public class TitleScene : Scene
{
    ...
    private void CreateTitlePanel()
    {
        ...
        startButton.Visual.Y = -80;
        startButton.Text = "Start";
        startButton.Click += HandleStartClicked;
        _titleScreenButtonsPanel.AddChild(startButton);

        _creditsButton = new AnimatedButton(_atlas);
        _creditsButton.Anchor(Gum.Wireframe.Anchor.Bottom);
        _creditsButton.Visual.X = 0;
        _creditsButton.Visual.Y = -60;
        _creditsButton.Text = "Credits";
        _creditsButton.Click += HandleCreditsClicked;
        _titleScreenButtonsPanel.AddChild(_creditsButton);

        _optionsButton = new AnimatedButton(_atlas);
        _optionsButton.Anchor(Gum.Wireframe.Anchor.Bottom);
        _optionsButton.Visual.X = 0;
        _optionsButton.Visual.Y = -40;
        ...
        quitButton.Visual.Y = -20;
        quitButton.Text = "Quit Game";
        quitButton.Click += HandleQuitClicked;
        _titleScreenButtonsPanel.AddChild(quitButton);
    ...
    private void HandleCreditsClicked(object sender, EventArgs e)
    {
        // A UI interaction occurred, play the sound effect
        Core.Audio.PlaySoundEffect(_uiSoundEffect);
